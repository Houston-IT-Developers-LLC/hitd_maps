#!/usr/bin/env python3
"""
HITD Maps - Batch 2 Scraping Script
Verified working APIs for California statewide and Louisiana parishes
"""
...
SOURCES = {
    # California Statewide - THE BIG ONE (13.1M parcels)
    "ca_statewide": {
    ...
    "la_east_baton_rouge": {
        "name": "Louisiana - East Baton Rouge Parish (Baton Rouge)",
        ...
        if result.returncode == 0:
            ...
            for line in result.stdout.split('\n'):
                if 'size' in line.lower():
                    print(f"  Verified: {pmtiles_name} ({line.strip()})")
                    return True
...
def main():
    parser = argparse.ArgumentParser(description='HITD Maps Batch 2 Scraper')
    ...
    print("\n" + "="*80)
    print("HITD Maps - Batch 2 Parcel Data Scraper")
    print("="*80)
