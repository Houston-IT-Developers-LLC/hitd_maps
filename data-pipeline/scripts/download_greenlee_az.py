#!/usr/bin/env python3
"""
Download Greenlee County, Arizona parcels from ArcGIS REST API
"""
...
# Configuration
FEATURE_SERVER_URL = "https://azwatermaps.azwater.gov/arcgis/rest/services/General/Parcels_for_TEST/FeatureServer/3"
OUTPUT_DIR = Path("/home/exx/Documents/C/hitd_maps/data-pipeline/downloads")
OUTPUT_FILE = OUTPUT_DIR / "greenlee_az_parcels.geojson"
MAX_RECORDS = 2000
...
def main():
    ...
    print(f"Greenlee County, Arizona Parcel Download")
    print(f"Source: {FEATURE_SERVER_URL}")
    print("=" * 60)
